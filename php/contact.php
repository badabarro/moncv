<?php
    ...
    $emailTo = "...@gmail.com"; //E-mail du recepteur
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") { 
        ...
        if(!isEmail($array["email"])) {
            $array["emailError"] = "Veuillez mettre un email valide !";
            $array["isSuccess"] = false; 
        } else {
        ...
        if (empty($array["message"])) {
            $array["messageError"] = "J'ai hate de savoir ce que vous voulez me dire !";
            $array["isSuccess"] = false; 
        } else {
